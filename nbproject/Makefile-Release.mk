...
${OBJECTDIR}/beelog/beelog.o: beelog/beelog.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/beelog.o beelog/beelog.c

${OBJECTDIR}/beelog/bhdata.o: beelog/bhdata.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/bhdata.o beelog/bhdata.c

${OBJECTDIR}/beelog/curlftp.o: beelog/curlftp.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/curlftp.o beelog/curlftp.c

${OBJECTDIR}/beelog/epaper/WhiteFrame.o: beelog/epaper/WhiteFrame.c
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/WhiteFrame.o beelog/epaper/WhiteFrame.c

${OBJECTDIR}/beelog/epaper/epd2in7.o: beelog/epaper/epd2in7.cpp
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/epd2in7.o beelog/epaper/epd2in7.cpp

${OBJECTDIR}/beelog/epaper/epdif.o: beelog/epaper/epdif.cpp
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/epdif.o beelog/epaper/epdif.cpp

${OBJECTDIR}/beelog/epaper/epdpaint.o: beelog/epaper/epdpaint.cpp
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/epdpaint.o beelog/epaper/epdpaint.cpp

${OBJECTDIR}/beelog/epaper/font12.o: beelog/epaper/font12.c
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/font12.o beelog/epaper/font12.c

${OBJECTDIR}/beelog/epaper/font16.o: beelog/epaper/font16.c
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/font16.o beelog/epaper/font16.c

${OBJECTDIR}/beelog/epaper/font20.o: beelog/epaper/font20.c
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/font20.o beelog/epaper/font20.c

${OBJECTDIR}/beelog/epaper/font24.o: beelog/epaper/font24.c
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/font24.o beelog/epaper/font24.c

${OBJECTDIR}/beelog/epaper/font8.o: beelog/epaper/font8.c
	${MKDIR} -p ${OBJECTDIR}/beelog/epaper
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epaper/font8.o beelog/epaper/font8.c

${OBJECTDIR}/beelog/epdwrapper.o: beelog/epdwrapper.cpp
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/epdwrapper.o beelog/epdwrapper.cpp

${OBJECTDIR}/beelog/get1wire.o: beelog/get1wire.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/get1wire.o beelog/get1wire.c

${OBJECTDIR}/beelog/getini.o: beelog/getini.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/getini.o beelog/getini.c

${OBJECTDIR}/beelog/getip.o: beelog/getip.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/getip.o beelog/getip.c

${OBJECTDIR}/beelog/hx711.o: beelog/hx711.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/hx711.o beelog/hx711.c

${OBJECTDIR}/beelog/ini.o: beelog/ini.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/ini.o beelog/ini.c

${OBJECTDIR}/beelog/isr.o: beelog/isr.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/isr.o beelog/isr.c

${OBJECTDIR}/beelog/main.o: beelog/main.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/main.o beelog/main.c

${OBJECTDIR}/beelog/raspimon.o: beelog/raspimon.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/raspimon.o beelog/raspimon.c

${OBJECTDIR}/beelog/readadc.o: beelog/readadc.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/readadc.o beelog/readadc.c

${OBJECTDIR}/beelog/readads.o: beelog/readads.c
	${MKDIR} -p ${OBJECTDIR}/beelog
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beelog/readads.o beelog/readads.c
